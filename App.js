    ...
    return (
      ...
      >
        <View style={styles.paywallContainer}>
            ...
            <>
              ...
              {hasLivePackages ? (
                livePackages.map((item) => {
                  const title = item.product?.title ?? item.identifier;
                ...
                // Empty-offerings state. NO purchase button is rendered here —
                // a tappable price tile without a working StoreKit purchase
                // behind it reads to App Review as a deceptive paywall.
                <View style={styles.emptyOfferingsContainer}>
                  <Text style={styles.emptyOfferingsTitle}>
                    Subscription pricing is loading from the App Store.
                  </Text>
                  <Text style={styles.emptyOfferingsBody}>
                    If this persists, the subscription product may still be
                    propagating through App Store Connect. Please try again
                    in a moment.
                  </Text>
                  <TouchableOpacity
          ...
          {/* Subscription Details — required by Apple Guideline 3.1.2(c).
              Displays title, length, price, and auto-renew terms adjacent
              to the purchase button before the StoreKit confirmation. */}
          ...
          {/* Required links — Privacy Policy and Apple Standard EULA.
              Both must be reachable from the paywall itself. */}
          <View style={styles.legalLinksContainer}>
            <TouchableOpacity
              style={styles.legalLinkButton}
              onPress={() => Linking.openURL('https://www.sauc-e.com/privatesupport')}
            >
